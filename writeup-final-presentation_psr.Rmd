...
<p>Next, we look at the desciptors of the complaints of the week surrounding January 8 2015. Similarly, we pick the period of 01/05/2015 - 01/11/2015 and plot of the counts of the top five descriptors of the week. As expected, the top descriptors are Entire Building and Apartment Only, which are associated with Heat/Hot Water complaints. The third most is Street Light Out, which is associated with complaints of Street Light Condition.</p>
...
-->
<iframe src="http://bl.ocks.org/minnich49/raw/fbeb70700c7c870ea016a28c4918f322/" width="100%" height="800px" frameborder="0"></iframe>
