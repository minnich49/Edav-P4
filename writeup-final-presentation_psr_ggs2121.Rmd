...
<span style="float:left;width: 100%;">
  <IMG SRC="Gary -ggs2121/Front slide.png" float = "left" ALT="image">
  </span>
<br />
<br />
<br />
...
<div class="slide">
<br/>
<center><font size="6" color ='#ffffff'> Prediction futur "Chaos Day" </font></center>
<br />
<br />
<br />
...
<br />
  ...
  <li><IMG SRC="Gary -ggs2121/RMSE formula.png" float = "center" ALT="image" height="100" width="200"></li>
...
<br />
<br />
The 311 databases is an amazing database to explore NYC through its best and worst days.
...
However, abnormal number of complaints are complicated to handle by agencies. Their ability to predict the number of complaints is key to optimize their organisation, response time and efficiency. 
