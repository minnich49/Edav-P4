...
However, abnormal number of complaints are complicated to handle by agencies. Their ability to predict the number of complaints is key to optimize their organization, response time and efficiency. 
